...
arr = [
    int(40 * math.sin(0.02*x) + 60 + random.random() * math.sin(0.0437*x) * 20) for x in range(480)
]
...
while 1:
    time.sleep(1)
    d.copy_rect((22, 0), (480, 127), (21, 0))
    y1 = max(min(y0 + int(random.random() * 10 - 5), 127), 0)
    d.set_color([7]*4)
    d.lines((478, 64), (479, 64))
    d.set_color([11]*4)
    d.lines((478, y0), (479, y1))
    y0 = y1
